        ...
        <div className="flex justify-center items-center w-full h-screen font-fontCaveat bg-gradient-to-r from-whiteI to-whiteF">
            <main className="flex justify-center items-center w-full h-5/6 max-w-screen-xl min-w-80 rounded-xl secondary-bg-color sm:flex-row">
                <div className="relative flex flex-col justify-center items-center h-full w-full rounded-2xl m-10 bg-secondS sm:basis-1/2 sm:rounded-l-2xl sm:rounded-r-none sm:m-0">
                    <img src={Vetor} className="absolute h-full w-auto left-full hidden sm:block" alt="" />
                    <h1 className="text-6xl mb-12 text-titleC caveat-primary">Cadastre-se</h1>
                    <div className="w-full p-4 sm:w-3/5 sm:p-0">
                        ...
                        <button className="w-5/12 h-10 rounded-lg border-none text-2xl bg-gradient-to-r from-btnI to-btnF text-zinc-50">Sign in</button>
                        <button className="w-5/12 h-10 rounded-lg border-solid border-2 text-2xl text-btnColor border-btnColor">Signup</button>
                     </div>
                    </div>
                ...
                <div className="relative basis-1/2 hidden justify-center items-center h-full rounded-2xl bg-gradient-to-r from-blueI to-blueF sm:flex sm:rounded-l-none">
                    <img src={VectorSignUp} className="w-72" alt="" />
                    <IoCloseSharp className="absolute right-6 top-6 text-zinc-50 size-8 "/>
                </div>
            </main>
        </div>
    )
